Public Class Class_Update
    ...
    Public Shared Sub UpdateLeave(ByVal Emplid As String, ByVal InputLeave As Double)
        Try
    ...
    Public Shared Sub UpdateLeaveIssue(ByVal Emplid As String, ByVal InputLeaveNewIssue As Double)
    ...
    Public Shared Function FixLeave()

        Dim query = db.Sp_FixLeave
